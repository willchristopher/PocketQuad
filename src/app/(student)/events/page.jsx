    ...
    return (<div className="space-y-6">
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        ...
        {!loading && filteredEvents.map((event, index) => {
            ...
            return (<article key={event.id} className="rounded-2xl border border-border/60 bg-card p-5 hover-lift animate-in-up" style={{ animationDelay: `${0.04 * (index + 1)}s` }}>
              <div className="flex items-start justify-between gap-3">
                ...
                <button onClick={() => void toggleInterest(event.id)} className={cn('rounded-lg border p-2 transition-all duration-200', event.isInterested
              ...
              <div className="mt-4 flex gap-2">
                ...
                <button onClick={() => void addToCalendar(event)} className={cn('inline-flex items-center gap-1 rounded-xl px-3 py-2 text-xs font-semibold transition-all duration-200', added
      ...
      {!loading && filteredEvents.length === 0 && (<section className="rounded-2xl border border-dashed border-border/60 bg-card p-10 text-center text-sm text-muted-foreground animate-in-up">
