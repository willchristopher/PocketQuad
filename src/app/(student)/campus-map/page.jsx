...
export default function CampusMapPage() {
    ...
    return (<div className="space-y-6">
      ...
      <section className="grid gap-4 md:grid-cols-2">
        ...
        {!loading && buildings.map((building, index) => (<article key={building.id} className="rounded-2xl border border-border/60 bg-card p-5 hover-lift animate-in-up" style={{ animationDelay: `${0.04 * (index + 1)}s` }}>
            ...
            <a href={buildDirectionsLink(building.mapQuery)} target="_blank" rel="noreferrer" className="mt-4 inline-flex items-center gap-1.5 rounded-xl border border-border/60 px-3 py-2 text-xs font-semibold transition-colors hover:bg-muted/35">
