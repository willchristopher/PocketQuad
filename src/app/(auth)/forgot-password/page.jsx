...
export default function ForgotPasswordPage() {
    ...
    return (<AuthShell>
      <div className="space-y-6">
        ...
        <AuthCard badge="Account Recovery" title={<>
              Recover your <span className="gradient-text">account</span>
            </>} description="Confirm your university email with a one-time passcode, then choose a new password." footer={<div className="text-center">
