...
function getRoleForAccessLevel(accessLevel, explicitRole) {
    if (explicitRole)
        return explicitRole;
    if (accessLevel === 'CLUB_PRESIDENT')
        return 'STUDENT';
    return 'ADMIN';
}
        ...
        const created = await prisma
            ...
            const user = await tx.user.create({
                data: {
                    ...
                    portalPermissions,
                    canPublishCampusAnnouncements: portalPermissions.includes('CAN_PUBLISH_ANNOUNCEMENTS'),
                },
            });
