...
async function getFacultyRecord(userId) {
    try {
...
export async function GET() {
    try {
        ...
        const studentAvailability = getStudentFacingFacultyAvailability(faculty.availabilityStatus, faculty.availabilityNote, faculty.officeHourSlots);
...
export async function PATCH(request) {
    try {
        ...
        const studentAvailability = getStudentFacingFacultyAvailability(updated.availabilityStatus, updated.availabilityNote, updated.officeHourSlots);
        return successResponse({
            ...updated,
