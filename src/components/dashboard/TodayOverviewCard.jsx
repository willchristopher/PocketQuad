...
export function TodayOverviewCard() {
    return (<div className="rounded-xl border border-border/60 bg-card overflow-hidden">
      ...
      <div className="divide-y divide-border/40">
        {schedule.map(item => (<div key={item.id} className={cn("p-4 flex items-center gap-3.5 hover:bg-muted/20 transition-colors cursor-pointer", item.current && "bg-primary/[0.03]")}>
