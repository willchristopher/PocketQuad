...
const mockDeadlines = [
    { id: '1', title: 'Algorithm Analysis Paper', course: 'CS 301', dueDate: new Date(new Date().setDate(new Date().getDate() + 1)), completed: false, priority: 'high' },
    { id: '2', title: 'Database Project Phase 1', course: 'CS 402', dueDate: new Date(new Date().setDate(new Date().getDate() + 3)), completed: false, priority: 'medium' },
    { id: '3', title: 'Weekly Quiz', course: 'MATH 201', dueDate: new Date(new Date().setDate(new Date().getDate() + 5)), completed: true, priority: 'low' },
    { id: '4', title: 'Research Paper Draft', course: 'ENG 302', dueDate: new Date(new Date().setDate(new Date().getDate() + 7)), completed: false, priority: 'medium' },
];
...
export function UpcomingDeadlinesWidget() {
    ...
    return (<div className="space-y-1">
      {sorted.map(d => {
            ...
            return (<div key={d.id} onClick={() => toggleComplete(d.id)} className={cn("flex items-center gap-3 p-2.5 rounded-xl cursor-pointer transition-all duration-200 group/dl", d.completed ? "opacity-40" : "hover:bg-muted/50")}>
            ...
            {d.priority === 'high' && !d.completed && (<div className={cn("p-1 rounded-lg", config.bg)}>
