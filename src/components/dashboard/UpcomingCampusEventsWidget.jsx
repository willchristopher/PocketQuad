...
export function UpcomingCampusEventsWidget() {
    return (<div className="space-y-2.5">
      {eventItems.map((event) => {
            ...
            return (<Link key={event.id} href={`/events/${event.id}`} className="group flex items-center gap-3 rounded-xl border border-border/50 px-3 py-3 transition-colors hover:bg-muted/40">
