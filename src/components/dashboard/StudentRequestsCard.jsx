...
import { Users2, CalendarDays, MessageSquare } from 'lucide-react';
...
const typeIcons = { appointment: CalendarDays, message: MessageSquare };
const typeColors = {
    ...
    return (<div className="rounded-2xl border border-border/60 bg-card overflow-hidden">
      ...
      <div className="divide-y divide-border/40">
        {requests.map((req, i) => {
            ...
            return (<div key={req.id} className="p-3.5 flex items-center gap-3 hover:bg-muted/20 transition-colors cursor-pointer">
