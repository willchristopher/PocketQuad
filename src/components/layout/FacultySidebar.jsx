...
export function FacultySidebar() {
    ...
    return (<aside className="hidden h-screen w-[240px] flex-col border-r border-border/50 bg-card/95 backdrop-blur-xl md:flex">
      ...
      <nav className="flex-1 overflow-auto px-3 py-4 custom-scrollbar">
        {navigationItems.map((item) => {
            ...
            return (<Link key={item.href} href={item.href} className={cn('flex items-center gap-3 rounded-xl px-3 py-2 text-sm transition-all', isActive
