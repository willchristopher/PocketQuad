    ...
    return (<header className="sticky top-0 z-20 flex h-14 w-full items-center gap-4 border-b border-border/50 bg-background/80 backdrop-blur-xl px-4 lg:px-6">
      ...
      <div className="w-full flex-1">
        <div className="relative max-w-md">
          ...
          <input type="search" placeholder="Search faculty tools..." className="w-full rounded-lg border border-border/60 bg-muted/30 pl-9 pr-4 py-1.5 text-xs text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/30 transition-colors"/>
        </div>
      </div>
