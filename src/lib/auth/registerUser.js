...
function assertSupportedSelfRegistrationRole(role) {
    if (role === 'ADMIN') {
        throw new ApiError(403, 'Admin accounts cannot be self-registered. Contact your university administrator.');
    }
}
