 ...
 */
/** @typedef {Record<DashboardModuleId, boolean>} DashboardPreferences */
...
export const externalPortalLinks = [
    {
        id: 'link-1',
        label: 'Canvas',
        category: 'Learning',
...
/**
 * @param {DashboardModuleId[] | null | undefined} dashboardModules
 * @returns {DashboardPreferences}
 */
export function dashboardModulesToPreferences(dashboardModules) {
    if (!dashboardModules) {
        return defaultDashboardPreferences;
    }
    return dashboardModuleIds.reduce((preferences, moduleId) => {
